...
//valor > node va a la derecha mayores derecha
//valor < node va a la izquierda menores izquierda
...
BinarySearchTree.prototype.breadthFirstForEach = function (cb,queue =[]) {
  // el queue es un array es la forma de ir guardando los valores de forma ordenada y tenerlos
...
//ejecutar root
  ...
  // revisar si hay elementos en la cola array y aplico recursion va sacando los elementos guardados en el array y ejecutando la funcion hasta que no queden mas elementos en el array 
  if(queue.length > 0) {
